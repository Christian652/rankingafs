								...
								<div class="card-body">
									<form method="POST" action="DAOuser.php">
										<div class="form-group">
											<label>Email</label>
											<input type="email" maxlength="200" name="email" class="form-control form-control-lg" placeholder="digite o email do usuario">	
										</div>

										<div class="form-group">
											<label>Senha</label>
											<input type="text" name="senha" maxlength="100" class="form-control form-control-lg" placeholder="digite a senha desse Usuario">	
										</div>
