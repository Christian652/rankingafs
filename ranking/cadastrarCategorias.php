	...
	<div class="d-flex">
		...
		<div class="content p-1 w-100">
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12">
						<h1 class="display-4">Cadastrar Categorias No SRTAAFS</h1>
							<div class="card">
								<div class="card-body">
									<form method="POST" action="DAOcategorias.php">
										<div class="form-group form-row">
											<div class="col-md-12">
												...
												<input type="text" maxlength="100" name="nome" class="form-control form-control-lg" placeholder="digite o nome da categoria">	
											</div>
										</div>
										<div class="form-group form-row">
											<div class="col-md-6">
												<label>Nota Minima</label>
												<input type="text" name="notaMinima" maxlength="4" class="form-control form-control-lg" placeholder="digite a nota minima para essa categoria">	
											</div>

											<div class="col-md-6">
												<label>Nota Limite</label>
												<input type="text" maxlength="4" name="notaLimite" class="form-control form-control-lg" placeholder="digite a nota maxima para essa categoria">	
											</div>
										</div>
										<button class="btn btn-primary" name="btn-cadastrar">
											Cadastrar
										</button>
									</form>
								</div>
