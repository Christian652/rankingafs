	...
	<div class="d-flex">
		...
		<div class="content p-1 w-100">
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12">
						<h1 class="display-4">Atualizar Alunos No SRTAAFS</h1>
							<div class="card">
								<div class="card-body">
								<?php 
								 ...
								 ?>
									<form method="POST" action="DAOaluno.php">
										<div class="form-group form-row">
											...
											<div class="col-md-4">
												<label>Curso</label>
												<input type="text" maxlength="120" name="curso" class="form-control form-control-lg" value="<?php echo $result['curso'];?>">	
											</div>
										</div>
										<div class="form-group form-row">
											<div class="col-md-7">
												<label>Media Geral</label>
												<input type="text" name="media" maxlength="5" class="form-control form-control-lg" value="<?php echo $result['media'];?>">	
											...
											<div class="col-md-5">
												...
												<select name="serie" class="form-control form-control-lg">
													<option value="<?php echo $result['serie'];?>" selected>
