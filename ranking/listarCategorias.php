	...
	<div class="d-flex">
		...
		<div class="content p-1 w-100">
			<div class="container">
				...
				<div class="row">
					<div class="col">
						<h1 class="display-4">Listar Categorias SRAAFS</h1>
					</div>
					<div class="col-12">
						<table class="table table-bordered table-hover table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo $row['notaMinima'];?></td>
									<td><?php echo $row['notaLimite'];?></td>
									<td><a href="updateCategorias.php?id=<?php echo $row['id'];?>" class="btn btn-success btn-block">Editar</a></td>
									<td><a href="deletarCategoria.php?id=<?php echo $row['id'];?>" class="btn btn-danger btn-block">Deletar</a></td>
								</tr>
								<?php endwhile; ?>
							</tbody>
						</table>
